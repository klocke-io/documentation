import{c as d,o,j as e,a}from"./chunks/framework.6Gpr8tQW.js";const s=JSON.parse('{"title":"API Reference","description":"","frontmatter":{"github_repo":"https://github.com/gardener/etcd-druid-api","github_subdir":"docs/api-reference","params":{"github_branch":"main"},"path_base_for_github_subdir":{"from":"content/docs/other-components/etcd-druid/api-reference.md","to":"druid.md"},"persona":"Developers","title":"API Reference","prev":false,"next":false},"headers":[],"relativePath":"docs/other-components/etcd-druid/api-reference/index.md","filePath":"docs/other-components/etcd-druid/api-reference.md","lastUpdated":null}'),c={name:"docs/other-components/etcd-druid/api-reference/index.md"},m=Object.assign(c,{setup(n){const r=`<p>Packages:</p>
<ul>
<li>
